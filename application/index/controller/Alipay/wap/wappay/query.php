...
require_once(APP_PATH.'/index/controller/Alipay/wap/service/AlipayTradeService.php');
require_once(APP_PATH.'/index/controller/Alipay/wap/buildermodel/AlipayTradeQueryContentBuilder.php');
require_once(APP_PATH."/index/controller/Alipay/wap/config.php");
