...
require_once(APP_PATH."/index/controller/Alipay/scan/AopSdk.php");
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/result/AlipayF2FPayResult.php');
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/result/AlipayF2FQueryResult.php');
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/result/AlipayF2FRefundResult.php');
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/result/AlipayF2FPrecreateResult.php');

require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/builder/AlipayTradeQueryContentBuilder.php');
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/model/builder/AlipayTradeCancelContentBuilder.php');
require_once(APP_PATH.'/index/controller/Alipay/scan/f2fpay/config/config.php');
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents (APP_PATH."/runtime/log/scanlog.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
