<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\phpStudy\WWW\ywd100\application/../Template/manage/index\index.html";i:1598606565;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	<title>北京知识一点通后台管理系统</title>
...
<body class="main_body">
	<div class="layui-layout layui-layout-admin">
		...
		<div class="layui-header header">
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="javascript:;" class="signOut" onclick="layui.loginout()"><i class="iconfont icon-loginout"></i> 退出</a>
			    	</li>
					...
					<li class="layui-nav-item" pc>
						<a href="javascript:;">
							<img src="/static/manage/images/timg.jpg" class="layui-circle" width="35" height="35">
							<cite><?php echo \think\Session::get('manageinfo')['username']; ?></cite>
						</a>
						<dl class="layui-nav-child">
							<!-- <dd><a href="javascript:;" data-url="page/user/userInfo.html"><i class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><cite>个人资料</cite></a></dd> -->
							<dd><a href="javascript:;" onclick="changePass()"><i class="iconfont icon-shezhi1"  data-icon="icon-shezhi1"></i><cite>修改密码</cite></a></dd>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				<a class="img" title="我的头像" ><img src="/static/manage/images/timg.jpg"></a>
		...
		<div class="layui-body layui-form">
			<div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
				<ul class="layui-tab-title top_tab" id="top_tabs">
					<li class="layui-this" lay-id=""><i class="layui-icon layui-icon-location"></i> <cite>后台首页</cite></li>
				</ul>
	...
	<script type="text/javascript" src="/static/manage/js/leftNav.js"></script>
	<script type="text/javascript" src="/static/manage/js/index.js"></script>
