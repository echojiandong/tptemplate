<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\ywd100\application/../Template/manage/textbook\TextBook.html";i:1598606565;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<script type="text/html" id="barDemo">
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="editTextBook">编辑</a>
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="delTextBook">删除</a>
</script>

<script type="text/javascript" src="/static/manage/layui//layui.js"></script>
<script type="text/javascript" src="/static/manage/js/textbook/textbookList.js"></script>
