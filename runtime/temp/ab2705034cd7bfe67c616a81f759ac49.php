<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\tp\ywd100\application/../Template/manage/weeklyReport\personStudyList.html";i:1598606566;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<script type="text/html" id="barDemo">
	<a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="editCode">学习详情</a>
	<!-- <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="forbidden">禁用</a> -->
</script>

<script type="text/javascript" src="/static/manage/layui/layui.js"></script>
<script type="text/javascript" src="/static/manage/js/weeklyReport/personstudyList.js"></script>
